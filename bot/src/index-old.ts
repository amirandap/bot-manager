// Unified WhatsApp bot with improved lifecycle management
...
import { BotLifecycleState } from './utils/botLifecycleTracker';
import { getFallbackNumber } from './utils/fallbackUtils';

// Import only essential routes that will be registered after client is ready
...
class UnifiedBotLifecycle {
    ...
    initializeClient(): void {
        ...
        try {
            ...
            // Export client for routes to use
    ...
    private setupClientEventListeners(): void {
        ...
        this._client.on('ready', () => {
            ...
            // NOW we initialize all the API routes
    ...
    private initializeAPIRoutes(): void {
        if (this._routesInitialized) {
            console.log('⚠️ API routes already initialized');
            return;
        }
        
        console.log('🚀 Initializing API routes...');
        
        // Register all messaging routes
        ...
        console.log('✅ API routes initialized and ready');
