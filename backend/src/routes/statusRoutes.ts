...
export function setStatusRoutes(app: Router) {
    ...
    app.get('/api/status/:id', statusController.getBotStatus.bind(statusController));
    ...
    app.get('/api/bots/:botId/status/metrics', botStatusController.getBotStatusViaMetrics.bind(botStatusController));
    app.get('/api/bots/:botId/metrics', botStatusController.getBotPM2Metrics.bind(botStatusController));
    app.get('/api/bots/:botId/health', botStatusController.getBotHealth.bind(botStatusController));
    app.get('/api/bots/metrics/all', botStatusController.getAllPM2Metrics.bind(botStatusController));
}